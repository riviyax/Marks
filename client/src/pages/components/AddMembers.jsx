...
function AddMembers() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMemberData({ id: "", name: "", position: "Member", marks: "", whatsappNumber: "" });
      handleClose();
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div className="mt-4 w-full space-y-4">
                      ...
                      <p className="text-xs text-gray-400 -mt-2">Enter with country code, no + sign. Sri Lanka: 947XXXXXXXX</p>
                    </div>
                  </div>
                </div>
              </div>
